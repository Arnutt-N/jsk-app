...
| 4 | Chatbot Management Hardening | Broadcast scheduler + CSV export wiring + rich menu size fix + Reply Objects ครบ types + (Could) narrowcast/multi-menu | 🔄 in-progress | with 5 | 3 | PR1 ✅ [report](../reports/chatbot-system-utilities-audit-phase4-pr1-report.md) · [plan](../plans/completed/chatbot-system-utilities-audit-phase4-pr1.plan.md) (Must-fixes) · PR2 Reply Objects (pending) |
