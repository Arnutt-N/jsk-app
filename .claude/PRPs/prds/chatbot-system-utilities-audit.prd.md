...
| 3 | Permissions v2 (module-based) | Extend permission_settings: keys ใหม่ Chatbot+System + UI 3-module + role presets + per-module override | in-progress | - | 1, 2 | [plan](../plans/chatbot-system-utilities-audit-phase3.plan.md) |
