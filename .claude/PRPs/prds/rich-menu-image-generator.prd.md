...
> ⚠️ **Gate ที่ต้องเคารพ**: Open Questions ระบุว่า *ถ้าอัตราการสร้างเมนูจริง < 1 ครั้ง/เดือน
> ควรหยุด PRD นี้* — Phase 1 ได้รับอนุญาตให้เดินก่อนในฐานะ **technical spike ที่ยังไม่ merge**
> จนกว่า gate นี้จะผ่าน ไม่ใช่การอนุมัติทั้งโครงการ
...
| 8 | Phase 1 = "APPROVED for implementation" | Open Questions เองระบุว่าถ้าอัตราการสร้างเมนูจริง < 1 ครั้ง/เดือน ควรหยุด PRD → Phase 1 เป็น **technical spike ที่ยังไม่ merge** จนกว่า gate นั้นจะผ่าน |

---

*Generated: 2026-08-02 (REV 4)*
*Status: Phase 1 **เริ่มได้ในฐานะ technical spike** — decision ปิดครบ, plan REV 4 พร้อม implement*
*⛔ Gate ก่อน merge Phase 1 และก่อนเข้า Phase 2: baseline การใช้งานจริง (ถ้า < 1 เมนู/เดือน ให้หยุด)*
*⚠️ ยังควรปิดก่อน Phase 2: คู่มือ branding ของ สธก. + ภาษาที่ต้องรองรับ*
