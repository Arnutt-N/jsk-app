...
- ~~`COOKIE_AUTH_MODE=bearer|dual|cookie`~~ **REMOVED (2026-08-22 cleanup PR)** — auth is cookie-only; a stale env value is silently ignored (`extra="ignore"`).
