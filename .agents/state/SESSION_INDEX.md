...
> **Last generated**: 2026-08-12 18:28 (from newest checkpoint)

## Quick Stats

| Metric | Value |
|--------|-------|
| Handoff checkpoints (active) | 212 |
| Session summaries on disk | 303 |
| Platforms | 9 (antigravity, claude_code, cline, codex, gemini_cli, kilo_code, kimi_code, open_code, qoder) |
| Most recent | 2026-08-12 18:28 — claude_code |
...
| When | Status | Model | Provider | Checkpoint |
|------|--------|-------|----------|------------|
| 2026-08-12 18:28 | completed | — | — | `handover-claude_code-20260812-1828.json` |
