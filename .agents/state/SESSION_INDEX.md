...
> **Last generated**: 2026-06-28 15:40 (from newest checkpoint)

## Quick Stats

| Metric | Value |
|--------|-------|
| Handoff checkpoints (active) | 114 |
| Session summaries on disk | 199 |
| Platforms | 8 (antigravity, claude_code, cline, codex, gemini_cli, kilo_code, kimi_code, open_code) |
| Most recent | 2026-06-28 15:40 — claude_code |
