...
> **Last generated**: 2026-07-02 23:55 (from newest checkpoint)

## Quick Stats

| Metric | Value |
|--------|-------|
| Handoff checkpoints (active) | 122 |
| Session summaries on disk | 208 |
| Platforms | 8 (antigravity, claude_code, cline, codex, gemini_cli, kilo_code, kimi_code, open_code) |
| Most recent | 2026-07-02 23:55 — claude_code |
